...
;(function($,document,window,undefined) {
	...
	$.fn.jCounter = function(options,callback) {
		...
		var pluralLabels = new Array('DÍAS','HORAS','MINUTOS','SEGUNDOS'); //plural labels - used for localization
		var singularLabels = new Array('DÍA','HORA','MINUTO','SEGUNDO');	//singular labels - used for localization
